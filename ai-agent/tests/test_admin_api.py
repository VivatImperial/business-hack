...
class AdminApiTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        os.environ["AI_AGENT_DATABASE_URL"] = (
            f"sqlite+aiosqlite:///{self.temp_dir.name}/admin-api.db"
        )
        os.environ["AI_AGENT_JWT_SECRET"] = "test-secret"
        os.environ["AI_AGENT_ADMIN_LOGIN"] = "admin"
        os.environ["AI_AGENT_ADMIN_EMAIL"] = "admin@example.com"
        os.environ["AI_AGENT_ADMIN_PASSWORD"] = "admin12345"
